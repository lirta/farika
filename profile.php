      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">BRANDA <i class="ion-ios-arrow-forward"></i></a></span> <span>PROFILE<i class="ion-ios-arrow-forward"></i></span></p>
          </div> 
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <p>PT. Farika Riau Perkasa merupakan perusahaan yang bergerak dalam bidang penyediaan readymix concrete (beton readymix), produk precast beton dan rental equipment untuk proyek-proyek pembangunan dan industri umum.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block ">
              <div class="icon d-flex justify-content-center align-items-center">
                <span class="flaticon-hook"></span>
              </div>
              <div class="media-body p-2 mt-6">
                <div class="media block-6 d-block text-center">
                <h3 class="heading">VISI</h3> </div>
                <ul>
                  <li>Menjadikan PT. FARIKA RIAU PERKASA sebagai perusahaan bersakala Nasional yang memproduksi beton readymix & precast yang berkualitas.</li>
                  <li>Pelayanan yang lebih baik.</li>
                  <li>Selalu melakukan inovasi dan improvisasi yang berkesinambungan agar dapat meningkatkan kinerja dengan efektif dan efisien.</li>
                </ul>
          ...
          <div class="col-md-6 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block">
              ...
              <div class="media-body p-2 mt-6">
                <div class="media block-6 d-block text-center">
                <h3 class="heading">MISI</h3> </div>
                <ul>
                  <li>Menyediakan beton readymix & precast dengan mutu terjamin.</li>
                  <li>Material berkualitas.</li>
                  <li>Volume tepat.</li>
                  <li>Harga bersaing.</li>
                  <li>Layanan yang sigap serta luwes.</li>
                </ul>
              </div>
            </div>    
          </div>
        ...
        <div class="row no-gutters">
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="project">
              ...
              <div class="text">
                <h3><a href="project.html">Gedung</a></h3>
              </div>
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="project">
              ...
              <div class="text">
                <h3><a href="project.html">Mall</a></h3>
              </div>
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="project">
              ...
              <div class="text">
                <h3><a href="project.html">Hotel</a></h3>
              </div>
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="project">
              ...
              <div class="text">
                <h3><a href="project.html">Jalan</a></h3>
              </div>
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="project">
              ...
              <div class="text">
                <h3><a href="project.html">Pabrik</a></h3>
              </div>
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="project">
              ...
              <div class="text">
                <h3><a href="project.html">Dermaga</a></h3>
              </div>

  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Profile <?php echo "$_SESSION[username]"; ?></h1>
            <p class="text-muted"> Lengkapi Data Anda Sebelum Melamar Pekerjaan</p>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Agama </b><a class="float-right"><?php echo "$kolom[agama]"; ?></a>
                  </li>
                  <li class="list-group-item">
                ...
                <a href="edit_profile.php" class="btn btn-primary "><b>Edit</b></a>
              </div>
            </div>
              <?php 
              $querip ="SELECT * FROM pendidikan WHERE pelamar='$_SESSION[username]'";
                  ...
                  <div class="tab-pane" id="settings">
                    <div class="post">
                      ...
                      <div class="row mb-12">
                        ...
                        <?php 
                        $querib ="SELECT * FROM berkas_pendukung";
                        ...
                        <div class="col-sm-12">
                          ...
                          <img class="img-fluid" src="<?php echo "berkas_foto/$kolomb[berkas]"; ?>" alt="Photo">
                        </div>
                        <?php $no=$no+1;
                 } 
                 ?>

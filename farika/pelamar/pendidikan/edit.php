          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              ...
              <div class="card-body">
                <!-- Date dd/mm/yyyy -->
                <?php 
                $queri ="SELECT * FROM pendidikan where id='$_GET[id]'";
                ...
                <div class="card-body col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="pen" style="width: 100%;"> 
                    <option><?php echo "$edit[pendidikan]"; ?></option>                   
                    <option>SMA</option>
                    <option>D3</option>
                    <option>S1</option>
                    <option>S2</option>
                  ...
                  <div class="form-group">
                    <label >Jurusan</label>
                    <input type="text" class="form-control" name="jur" value="<?php echo "$edit[jurusan]"; ?>">
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <img src="<?php echo"../berkas_foto/$edit[ijazah]"; ?>" width="500xp">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">File Transkip nilai</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="exampleInputFile" name="tn" >
                        <label class="custom-file-label" for="exampleInputFile" >Choose file</label>
                      </div>
                    </div>

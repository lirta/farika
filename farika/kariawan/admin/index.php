            ...
            <div class="container-fluid">
              ...
              <div class="row">
                ...
                while ($kolom = mysqli_fetch_assoc($hasil)) {
                  $queril = "SELECT * FROM lamaran  where lowongan='$kolom[lowongan_id]' ";
                  $hasill = mysqli_query($koneksi, $queril);
                  $koloml = mysqli_num_rows($hasill); ?>
                  <div class="col-lg-3 col-6">
                    <!-- small box -->
                    <div class="small-box bg-info">
                      <div class="inner">
                        <h3><?php echo "$koloml"; ?> pelamar</h3>
                        <p><?php echo "$kolom[lowongan_posisi]"; ?></p>
                      </div>
                      <div class="icon">

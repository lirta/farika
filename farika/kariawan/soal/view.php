          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <!-- /.card-header -->
                <?php
                $qk = mysqli_query($koneksi, "SELECT * FROM kategori_soal");
                while ($kat = mysqli_fetch_assoc($qk)) {
                ?>

                  <div class="card-body">
                    <h3>Soal <?php echo "$kat[nama]" ?></h3>
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <?php
                        $queri = "SELECT * FROM soal WHERE kategori_soal_id='$kat[kategori_soal_id]'";

                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            ?><tr>
                                                    ...
                                                    <td>
                                                        <form role="form" action="laporan_pdf.php" method="post" enctype="multipart/form-data">
                                                            <div class="card-body col-md-8">
                                                                <div class="form-group" hidden>
                                                                    <label>id</label>
                                                                    <input type="text" class="form-control" name="id" value="<?php echo "$kolom[lowongan_id]"; ?>">
                                                                </div>
                                                            </div>
